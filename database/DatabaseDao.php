...
abstract class DatabaseDao implements DataAccessObject{
    ...
    public function getByCriteria(string $criteria, string $value, string $errorMsg = "No results match the criteria supplied") {
    ...
    public function getAll() {
        return $this->getByCriteria('?', '1', "There were no results in the table specified, $this->tablename");
    }
    
    public function getById(string $id) {      
        return $this->getByCriteria('id=?', $id, "No results match the id supplied")[0];
    }
